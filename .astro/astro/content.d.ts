...
"39-kintone-hubspot-comparison.md": {
	id: "39-kintone-hubspot-comparison.md";
  slug: "39-kintone-hubspot-comparison";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
"40-data-hub-professional-value.md": {
	id: "40-data-hub-professional-value.md";
  slug: "40-data-hub-professional-value";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
"41-zendesk-hubspot-migration.md": {
	id: "41-zendesk-hubspot-migration.md";
  slug: "41-zendesk-hubspot-migration";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
"42-manufacturing-hubspot.md": {
	id: "42-manufacturing-hubspot.md";
  slug: "42-manufacturing-hubspot";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
...
"66-crm-input-incentive.md": {
	id: "66-crm-input-incentive.md";
  slug: "66-crm-input-incentive";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
"67-sales-activity-tracking.md": {
	id: "67-sales-activity-tracking.md";
  slug: "67-sales-activity-tracking";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
"68-inside-field-sales-handoff.md": {
	id: "68-inside-field-sales-handoff.md";
  slug: "68-inside-field-sales-handoff";
  body: string;
  collection: "blog";
  data: InferEntrySchema<"blog">
} & { render(): Render[".md"] };
