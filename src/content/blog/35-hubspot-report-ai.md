...
![MCP連携だけで生成された営業パイプライン健全性ダッシュボード。パイプライン総額・取引件数・初期ステージ滞留・単一窓口の高額案件のKPIと、ステージ別・金額帯別・窓口体制別のグラフ](/images/blog/hubspot-report-ai-dashboard.png)

![MCP連携だけで生成された都市別の商談金額グラフ](/images/blog/hubspot-report-ai-dashboard-city.png)

さらに、AIにスプレッドシートへの出力まで頼むと、サマリー・主要な発見・改善アクションから、シートごとの集計表とグラフまで揃ったレポートファイルがそのまま出来上がります。
