...
ステージ設計の観点では、入力を必須にする項目を増やしすぎないことも重要です。商談ステージの定義と必須項目の線引きは、[商談ステージの設計｜主観をなくす条件と増やしすぎない線](/blog/62-deal-stage-design/)にまとめています。

入力すると営業自身が得をする仕組み——日報や毎日の報告をなくし、入力を報告の代わりにする設計——は、[営業がCRMに入力する理由を作る｜日報と報告をなくす設計](/blog/66-crm-input-incentive/)にまとめています。
