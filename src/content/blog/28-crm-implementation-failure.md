...
## 失敗パターン7：拡張性のないCRMを選ぶ

最初から完璧なCRMを作ろうとする必要はありません。むしろスモールスタートが正解です。SaaSのツールは、後から必要に応じて機能を付け足したり、連携を増やしたりすることができます。

「最初からすべてを盛り込まなくていい」——これは先ほどの「夢見すぎ」の話とも重なります。

ただし、ひとつだけ最初に確認しておくべきことがあります。それが**「拡張できるかどうか」**です。

後から機能追加・連携追加・プランアップグレードができる設計のCRMを選ぶことが前提です。拡張性のないCRMを最初に選んでしまうと、事業が成長したとき、あるいは業務が変わったときに詰んでしまいます。「後から何でも足せる」という余地を持たせたうえで、小さく始めることが正解です。
