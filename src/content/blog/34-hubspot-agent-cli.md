...
description: "2026年6月にベータリリースされたHubSpot Agent CLI。Claude CodeなどのAIエージェントからHubSpotを直接操作できる公式ツールを、実際にデモポータルで検証。セットアップからdry-runの挙動、コネクタ連携との使い分けまで解説します。"
pubDate: 2026-07-13
category: "HubSpot×AI"
tags: ["HubSpot", "AI", "Agent CLI", "Claude Code", "コネクタ"]
...
「どれか一つを選ぶ」のではなく、**チャットで聞くのはコネクタ、一括処理はAgent CLI、基幹の自動化はAPI**という使い分けを、社内の誰がどの業務を担うかに合わせて設計する。これがHubSpot×AI活用の導入ポイントだと考えています。
