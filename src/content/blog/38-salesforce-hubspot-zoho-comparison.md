...
- 営業担当者が50人以上いるような、営業組織の規模が大きい企業
- 複数の製品チーム・営業所・顧客セグメントで組織が複雑に分かれており、チームごとの画面カスタマイズや細かい権限制御が必要な企業

理由はシンプルで、**この複雑さに応えられるカスタマイズ性は3つの中で唯一無二**だからです。組織の複雑さをツール側が受け止めきれないと、現場は「ツールに業務を合わせる」ことを強いられます。Salesforceはそれを最も回避しやすいツールです。

### HubSpotが向いている会社

- デジタルマーケティングに注力している、またはこれから注力したい会社
- 規模としては中小から大企業まで対応しますが、特に中堅・中小規模とのフィットが良い

理由は、マーケティング機能の強さと、マーケティングから営業・サポートまでを単一プラットフォームで一元管理できることです。そして何より、**UIが使いやすく、現場に定着させやすいこと**。ツールは定着して初めて投資が回収できます。
