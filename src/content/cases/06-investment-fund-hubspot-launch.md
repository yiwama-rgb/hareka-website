...
[ExcelからHubSpotへ移行する際のポイント](/blog/43-excel-to-hubspot/)は、オブジェクト設計やレポート再現の難所を別記事にまとめています。

[金融業界でのHubSpot活用](/blog/46-finance-hubspot/)は、必要な投資と見送るべき条件を別記事にまとめています。
