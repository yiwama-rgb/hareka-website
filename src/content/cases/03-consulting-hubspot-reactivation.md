...
月1回・約1年半という伴走の中で、業務フローを一緒に確認し、トッププレイヤーの型を仕組みに落とし込み、あえて使わない機能まで判断する――。数々の営業現場を支援した経験に加えて、代表岩間が自身で営業現場を深く経験した知見から「現場が本当に使ってくれる仕組み」を構築できたことがHubSpot再活用の大きなポイントでした。
